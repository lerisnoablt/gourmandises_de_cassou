...
Version actuelle : V19 — accueil simplifié
...
## V18 — Mobile premium et navigation responsive

Cette version garde les fonctions de la V17 et améliore surtout l’expérience mobile.

Améliorations principales :

- ajout d’une navigation desktop/tablette dans le header :
  - Menu ;
  - Nous trouver ;
  - Panier ;
- sur mobile, le header disparaît quand le client défile pour laisser plus d’espace ;
- ajout d’une barre d’onglets mobile en bas :
  - Accueil ;
  - Menu ;
  - Panier ;
  - Carte ;
- le bouton Carte renvoie vers la carte intégrée dans le site ;
- suppression du doublon avec le bouton panier flottant sur mobile ;
- amélioration des zones tactiles sur téléphone ;
- amélioration de la lisibilité mobile du header, des cartes, du panier et des boutons ;
- conservation des fonctions utiles :
  - panier ;
  - paiement ;
  - WhatsApp ;
  - carte ;
...
## V19 — Accueil simplifié

Cette version allège la première section du site pour éviter les répétitions.

Corrections principales :

- suppression du bloc logo dans la section d’accueil ;
- suppression des boutons “Choisir une catégorie” et “Voir mon panier” dans le hero ;
- conservation de la navigation principale :
  - header sur ordinateur/tablette ;
  - barre mobile en bas sur téléphone ;
- texte d’accueil rendu plus direct ;
- infos rapides conservées mais rendues plus compactes ;
- meilleure respiration entre l’accueil et le menu ;
- aucune fonctionnalité utile supprimée.

But de cette version :

- rendre l’accueil plus clair ;
- éviter les doublons ;
- faire arriver le client plus vite vers le menu ;
- garder le site propre sur mobile, tablette et ordinateur.
